...
public class VentaPDF {
    ...
    public void generarFacturaPDF() {
        try {
            ...
            String ruc = "1712745148001";
            String nombre = "Ferretería El Fluorescente";
            String telefono = "0987654321";
            String direccion = "La Armenia Luis Felipe Borja N°12 - 300 - Conocoto";
            String email = "janet.quishpe@gmail.com";
            ...
            //tamaño de las celdas
            float[] ColumnaCliente = new float[]{25f, 40f, 25f, 30f, 30f};
            ...
            PdfPCell cliente5 = new PdfPCell(new Phrase("Email: ", negrita));
            //quitar bordes 
            ...
            for(int i = 0; i < InterFacturacion.jTable_productos.getRowCount(); i++){
                ...
                String total = InterFacturacion.jTable_productos.getValueAt(i, 4).toString();
            ...
            //Total pagar
            Paragraph infoSubtotal = new Paragraph();
            infoSubtotal.add(Chunk.NEWLINE);
            infoSubtotal.add("Subtotal: " + InterFacturacion.txt_subtotal.getText());
            infoSubtotal.setAlignment(Element.ALIGN_RIGHT);
            doc.add(infoSubtotal);
            
            
            //Total pagar
            Paragraph infoIva = new Paragraph();
            infoIva.add(Chunk.NEWLINE);
            infoIva.add("Iva: " + InterFacturacion.txt_iva.getText());
            infoIva.setAlignment(Element.ALIGN_RIGHT);
            doc.add(infoIva);
