...
public class DetalleVenta {
    ...
    public DetalleVenta(int idDetalleVenta, int idCabeceraVenta, int idProducto, String nombre, int cantidad, double precioUnitario, double totalPagar, int estado) {
